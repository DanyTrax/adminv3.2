...
static public function ctrCrearVenta() {
    ...
    if (isset($_POST["nuevaVenta"])) {
        ...
        if ($respuesta === "ok") {
            ...
            $detalleEntrada = "Venta factura No. " . $codVenta . " por " . $_SESSION["nombre"];
            ...
            ModeloContabilidad::save([
                "id_vendedor" => $_POST["idVendedor"], "fecha" => $fechaHora,
                "detalle"     => $detalleEntrada, "valor" => $valorContable,
                "medio_pago"  => $_POST["nuevoMedioPago"] ?? "", "forma_pago"  => $_POST["nuevoMetodoPago"],
                "factura"     => $codVenta, "tipo" => "Entrada"
            ]);
